    ...
    <div className="md:flex flex-wrap -m-4">
      <div className="p-4 md:w-1/3 w-full">
        <div className="h-full bg-gray-100 p-8 rounded">
          ...
          <a className="inline-flex items-center">
            <img alt="testimonial" src="/testi1.jpg" className="w-12 h-12 border-3 border-blue-500 rounded-full flex-shrink-0 object-cover object-center" />
            <span className="flex-grow flex flex-col pl-4">
              <span className="title-font font-medium text-gray-900">Haroon</span>
      ...
      <div className="p-4 md:w-1/3 w-full">
        <div className="h-full bg-gray-100 p-8 rounded">
          ...
          <p className="leading-relaxed mb-6">Synth chartreuse iPhone lomo cray raw denim brunch everyday carry neutra before they sold out fixie 90's microdosing. Tacos pinterest fanny pack venmo, post-ironic heirloom try-hard pabst authentic iceland.</p>
          <a className="inline-flex items-center">
            <img alt="testimonial" src="/testi2.jpg" className="w-12 h-12 border-3 border-blue-500 rounded-full flex-shrink-0 object-cover object-center" />
            <span className="flex-grow flex flex-col pl-4">
      ...
      <div className="p-4 md:w-1/3 w-full">
        <div className="h-full bg-gray-100 p-8 rounded">
          ...
          <p className="leading-relaxed mb-6">Synth chartreuse iPhone lomo cray raw denim brunch everyday carry neutra before they sold out fixie 90's microdosing. Tacos pinterest fanny pack venmo, post-ironic heirloom try-hard pabst authentic iceland.</p>
          <a className="inline-flex items-center">
            <img alt="testimonial" src="/testi3.jpg" className="w-12 h-12 border-3 border-blue-500 rounded-full flex-shrink-0 object-cover object-center" />
            <span className="flex-grow flex flex-col pl-4">
              <span className="title-font font-medium text-gray-900">Alper Kamu</span>
              <span className="text-gray-500 text-sm">DESIGNER</span>
            </span>
